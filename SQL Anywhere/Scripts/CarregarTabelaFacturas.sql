INSERT INTO Facturas (IDFactura, IDFornecedor, NúmeroFactura, DataFactura, TotalFactura, Pagamento, Crédito, CondiçãoPagamento, DataVencimentoFactura, DataPagamento)
